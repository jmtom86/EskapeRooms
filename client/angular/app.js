    ...
    myApp.directive('timerDirective', function(){
    return {
        restrict: 'A',
        scope: true,
        link: function(scope, elem, attrs){
            elem.click(function(){
                ...
                // document.getElementById("pwmsg1").play();
                scope.socket.emit(attrs.attr);
            });
        }
...
//     myApp.directive('volDirective', function(){
//     return {
//         restrict: 'A',
//         scope: true,
//         link: function(scope, elem, attrs){
...
//                 console.log(scope.socket);
//                 // document.getElementById("pwmsg1").play();
//                 scope.socket.emit(attrs.attr, {volume: vol});
//             });
//         }
...
// })
    ...
    myApp.directive('flipClock', function(){
        return{
            restrict: 'A',
            scope: true,
            link: function(scope, elem, attrs){
                // console.log(attrs.attr);
                var clock = $(elem).FlipClock(3600,{countdown:true, autoStart:false, clockFace: 'MinuteCounter'});
                scope.grabClock(clock);
            }
        }
        
    })

  //   myApp.directive('flipClock', ['$parse', function($parse) {
  //   return {
  //     replace: true,
  //     template: '<div></div>',
  //     restrict: 'E',
